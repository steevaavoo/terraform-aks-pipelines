...
call az group create --location %RESOURCE_LOCATION% --name %TERRAFORMSTORAGERG%
...
call az storage container create --name %TF_CONTAINER_NAME% --account-name %TERRAFORMSTORAGEACCOUNT%
